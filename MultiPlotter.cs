...
namespace PrintWizard
{
    ...
    const String acedTrans_x86_Prefix = "_";
        ...
        static public void MultiSheetPlot(String pageSize, String plotter, String outputFileName)
        {
        ...
        public static void MyPlot()
        {
            ...
            using (doc.LockDocument())
            {
                ...
                MultiSheetPlot(MyPageSize, MyPlotter, MySavePath);
                ed.WriteMessage("\nThe \"{0}\" file created.\n", "");
            }
